...
#
#  $ bin/test -s genweb6.rrhh -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src genweb6.rrhh.testing.GENWEB6_RRHH_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/genweb6/rrhh/tests/robot/test_example.robot
#
